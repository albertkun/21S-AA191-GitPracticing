...
Mental Health Group | Icon Pulse | We think the pulse can emphasize the location of physical resources that people may find helpful. It is easier for users to distinguish where is the location of resources. | https://kennl42.github.io/21S-ASIAAM-191A-Assignments/Week_10/index.html
...
West LA Food Empowerment | Leaflet Control Window | This is a very useful feature that we believe can allow us to better introduce our project goals and improve navigation for our users. It's really cool that you can modify the HTML within the window, making it easier to edit what's being displayed. We may add a button to our page that will allow users to revisit the popup if they would like to. | https://wny-duong.github.io/WebDev-GIS-Health-Equity/leaflet-storymaps-with-google-sheets-main/#4 |
